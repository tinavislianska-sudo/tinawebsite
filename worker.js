...
Currently: Founding AI Growth Systems Lead at CogniAgent (built a customer intelligence system combining Reddit research, competitor monitoring, and feedback; reduced cost per lead by 80%; automated 90% of repetitive workflows; increased content production capacity 80% using Claude Code and Remotion) and AI Search & Intelligence Strategist at Glorium Technologies | NikoHealth (built a GEO system spanning Reddit citation strategy, LinkedIn authority content, and AI-crawler audits for a US healthcare B2B SaaS; achieved recurring monthly citations in ChatGPT and Perplexity).
